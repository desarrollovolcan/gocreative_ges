        ...
        <form method="post" action="index.php?route=hr/contracts/update">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="employee_id" class="form-select" required>
                        ...
                        <?php foreach ($employees as $employee): ?>
                            <option value="<?php echo (int)$employee['id']; ?>" <?php echo ((int)$contract['employee_id'] === (int)$employee['id']) ? 'selected' : ''; ?>>
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="start_date" class="form-control" value="<?php echo e($contract['start_date'] ?? ''); ?>" required>
                </div>
                <div class="col-md-4">
