 ...
 * @Packge      Lonyo
 * @Author      Mthemeus
 * @Author URL  https//www.mthemeus.com
 * @version     1.0
 *
 */

if ( ! function_exists( 'lonyo_breadcrumbs' ) ) {
    function lonyo_breadcrumbs( $args = array() ) {
        if ( is_front_page() ) {
            return;
        }
        ...
        $defaults  = array(
            ...
            'home_title'          => esc_html__( 'Home', 'lonyo' )
        );
        $args    = apply_filters( 'lonyo_breadcrumbs_args', wp_parse_args( $args, $defaults ) );
        ...
        */
        ...
        if ( is_singular( 'post' ) ) {
            ...
            $html .= '<li class="active bread-search">'.esc_html__('Search results for: ','lonyo') . get_search_query() . '</li>';
        } elseif ( is_404() ) {
            $html .= '<li>' . esc_html__( 'Error 404', 'lonyo' ) . '</li>';
        } elseif ( is_home() ) {
        ...
        if ( function_exists( 'is_woocommerce' ) && is_woocommerce() ) {
            ...
            echo apply_filters( 'lonyo_breadcrumbs_filter', $html );
        }
