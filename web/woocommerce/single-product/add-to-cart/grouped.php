...
<form class="cart grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
        ...
        <div class="actions">
		    ...
		    <button type="submit" class="single_add_to_cart_button lonyo-btn shadow-none"><?php echo esc_html( $product->single_add_to_cart_text() ); ?><i class="fas fa-shopping-bag"></i></button>
			<?php
				// Wishlist Button
