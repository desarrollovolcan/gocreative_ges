...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
		<div class="row">
			<?php
				if( class_exists('CSF') ) {
					...
					if( $lonyo_woo_singlepage_sidebar == '2' && is_active_sidebar('lonyo-woo-sidebar') ) {
						echo '<div class="col-lg-8 col-xl-9 order-last">';
					} elseif( $lonyo_woo_singlepage_sidebar == '3' && is_active_sidebar('lonyo-woo-sidebar') ) {
				...
				/**
				 * Hook: lonyo_woocommerce_single_product_sidebar.
				 *
				 * @hooked lonyo_woocommerce_single_product_sidebar_cb - 10
				 */
				do_action( 'lonyo_woocommerce_single_product_sidebar' );
			?>
	...
	<?php do_action( 'lonyo_woocommerce_output_related_products' ); ?>
