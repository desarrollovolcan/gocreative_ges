...
if ( $max_value && $min_value === $max_value ) {
	...
	?>
		<?php do_action( 'woocommerce_before_quantity_input_field' ); ?>
            ...
            <button type="button" class="quantity-minus qty-btn"><i class="fas fa-minus"></i></button>
            <input
                type="number"
            ...
            <button type="button" class="quantity-plus qty-btn"><i class="fas fa-plus"></i></button>
