...
add_filter( 'loop_shop_per_page', 'lonyo_new_loop_shop_per_page', 20 );
function lonyo_new_loop_shop_per_page( $product_count ) {
  $wctab = lonyo_opt('lonyo_wc_settings');
  if ( is_array($wctab) && isset($wctab['lonyo_woo_product_perpage']) ) {
    $product_count = $wctab['lonyo_woo_product_perpage'];
  }
...
add_filter('woocommerce_product_loop_start','lonyo_woocommerce_product_loop_start');
function lonyo_woocommerce_product_loop_start( ) {
    echo '<div class="row">';
}

// wooocommerce product loop start filter
add_filter('woocommerce_product_loop_end','lonyo_woocommerce_product_loop_end');
function lonyo_woocommerce_product_loop_end( ) {
    echo '</div>';
}

// woocommerce format sale price
add_filter('woocommerce_format_sale_price','lonyo_woocommerce_format_sale_price',10,3);
function lonyo_woocommerce_format_sale_price( $price, $regular_price, $sale_price ) {
...
add_filter('woocommerce_review_gravatar_size','lonyo_woocommerce_review_gravatar_size');
function lonyo_woocommerce_review_gravatar_size() {
    return 65;
}
...
add_filter('woocommerce_output_related_products_args','lonyo_woocommerce_output_related_products_args',10,1);
function lonyo_woocommerce_output_related_products_args( $args ) {
    if( class_exists('CSF') ) {
        $args['posts_per_page'] = lonyo_opt('lonyo_woo_relproduct_num');
    } else {
...
add_filter('woocommerce_upsell_display_args','lonyo_woocommerce_upsell_display_args',10,1);
function lonyo_woocommerce_upsell_display_args( $args ) {
    if( class_exists('CSF') ) {
        $wctab = lonyo_opt('lonyo_wc_settings');
        $args['posts_per_page'] = $wctab['lonyo_woo_upsellproduct_num'];
    } else {
        $args['posts_per_page'] = '3';
    }
    return $args;
...
function woocommerce_cross_sells_total( $limit ) {
    if( class_exists('CSF') ) {
        $wctab = lonyo_opt('lonyo_wc_settings');
        $limit =  $wctab['lonyo_woo_crosssellproduct_num'];
    } else {
        $limit = '3';
    }
...
// Ajax Cart Count
add_filter( 'woocommerce_add_to_cart_fragments', 'lonyo_refresh_mini_cart_count');
function lonyo_refresh_mini_cart_count($fragments){
    ob_start();
    ?>
...
// Checkout fields
add_filter( 'woocommerce_checkout_fields' , 'lonyo_override_checkout_fields' );
function lonyo_override_checkout_fields( $fields  ){
    ...
    $fields['billing']['billing_first_name']['class'] = array('col-12');
    $fields['billing']['billing_first_name']['input_class'] = array('form-control');
    $fields['billing']['billing_first_name']['placeholder'] = esc_attr__('First Name', 'lonyo');
    $fields['billing']['billing_first_name']['priority'] = 1;

    $fields['billing']['billing_last_name']['class'] = array('col-12');
    $fields['billing']['billing_last_name']['input_class'] = array('form-control');
    $fields['billing']['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'lonyo');
    $fields['billing']['billing_last_name']['priority'] = 2;

    $fields['billing']['billing_company']['class'] = array('col-12');
    $fields['billing']['billing_company']['input_class'] = array('form-control');
    $fields['billing']['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'lonyo');
    $fields['billing']['billing_company']['priority'] = 3;

    $fields['billing']['billing_phone']['class'] = array('col-12');
    $fields['billing']['billing_phone']['input_class'] = array('form-control');
    $fields['billing']['billing_phone']['placeholder'] = esc_attr__('Phone', 'lonyo');
    ...
    $fields['billing']['billing_email']['placeholder'] = esc_attr__('Email address', 'lonyo');
    ...
    $fields['billing']['billing_city']['class'] = array('col-12');
    $fields['billing']['billing_city']['input_class'] = array('form-control');
    $fields['billing']['billing_city']['placeholder'] = esc_attr__('Town / City', 'lonyo');
    $fields['billing']['billing_city']['priority'] = 10;

    $fields['billing']['billing_postcode']['class'] = array('col-12');
    $fields['billing']['billing_postcode']['input_class'] = array('form-control');
    $fields['billing']['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'lonyo');
    $fields['billing']['billing_postcode']['priority'] = 11;

    $fields['shipping']['shipping_first_name']['class'] = array('col-12');
    $fields['shipping']['shipping_first_name']['input_class'] = array('form-control');
    $fields['shipping']['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'lonyo');
    $fields['shipping']['shipping_first_name']['priority'] = 1;

    $fields['shipping']['shipping_last_name']['class'] = array('col-12');
    $fields['shipping']['shipping_last_name']['input_class'] = array('form-control');
    $fields['shipping']['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'lonyo');
    ...
    $fields['shipping']['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'lonyo');
    ...
    $fields['shipping']['shipping_phone']['placeholder'] = esc_attr__('Phone', 'lonyo');
    ...
    $fields['shipping']['shipping_email']['placeholder'] = esc_attr__('Email address', 'lonyo');
    ...
    $fields['shipping']['shipping_city']['class'] = array('col-12');
    $fields['shipping']['shipping_city']['input_class'] = array('form-control');
    $fields['shipping']['shipping_city']['placeholder'] = esc_attr__('Town / City', 'lonyo');
    $fields['shipping']['shipping_city']['priority'] = 10;

    $fields['shipping']['shipping_postcode']['class'] = array('col-12');
    $fields['shipping']['shipping_postcode']['input_class'] = array('form-control');
    $fields['shipping']['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'lonyo');
...
add_filter( 'woocommerce_default_address_fields', 'lonyo_override_default_locale_fields' );
function lonyo_override_default_locale_fields( $fields ) {
...
add_filter( 'woocommerce_billing_fields' , 'lonyo_custom_billing_fields' );
function lonyo_custom_billing_fields( $fields ) {
    ...
    $fields['billing_first_name']['placeholder'] = esc_attr__('First Name', 'lonyo');
    ...
    $fields['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'lonyo');
    ...
    $fields['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'lonyo');
    ...
    $fields['billing_phone']['placeholder'] = esc_attr__('Phone', 'lonyo');
    ...
    $fields['billing_email']['placeholder'] = esc_attr__('Email address', 'lonyo');
    ...
    $fields['billing_city']['placeholder'] = esc_attr__('Town / City', 'lonyo');
    ...
    $fields['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'lonyo');
...
add_filter( 'woocommerce_shipping_fields' , 'lonyo_custom_shipping_fields' );
function lonyo_custom_shipping_fields( $fields ) {

    // Shipping Fields

    $fields['shipping_first_name']['class'] = array('col-lg-6');
    $fields['shipping_first_name']['input_class'] = array('form-control');
    $fields['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'lonyo');
    ...
    $fields['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'lonyo');
    ...
    $fields['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'lonyo');
    ...
    $fields['shipping_phone']['placeholder'] = esc_attr__('Phone', 'lonyo');
    ...
    $fields['shipping_email']['placeholder'] = esc_attr__('Email address', 'lonyo');
    ...
    $fields['shipping_city']['placeholder'] = esc_attr__('Town / City', 'lonyo');
    ...
    $fields['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'lonyo');
...
// Add Related Product
add_action( 'lonyo_woocommerce_output_related_products', 'woocommerce_output_related_products', 20 );

// Shop column start wrapper hook
add_action( 'woocommerce_before_main_content', 'lonyo_shop_col_start_cb', 10 );

// Shop column end wrapper hook
add_action('woocommerce_after_main_content','lonyo_shop_col_end_cb',10);

// Category Section Start
add_action( 'lonyo_shop_categorysection_start', 'lonyo_shop_categorysection_start_cb', 10 );

// shop main content hook
add_action('lonyo_shop_main_content','lonyo_shop_main_content_cb',10);

// shop main content end hook
add_action('lonyo_shop_main_content_end','lonyo_shop_main_content_end_cb',10);

// lonyo woocommerce pagination hook
add_action('woocommerce_after_shop_loop','lonyo_woocommerce_pagination',10);

// lonyo woocommerce filter wrapper hook
add_action('woocommerce_before_shop_loop','lonyo_woocommerce_filter_wrapper',20);

// lonyo woocommerce product content wrapper
add_action('lonyo_woocommerce_product_content', 'lonyo_woocommerce_tab_content_wrapper_start', 10 );
add_action('lonyo_woocommerce_product_content', 'lonyo_grid_tab_content_cb', 10 );
add_action('lonyo_woocommerce_product_content', 'lonyo_list_tab_content_cb', 20 );
add_action('lonyo_woocommerce_product_content', 'lonyo_woocommerce_tab_content_wrapper_end', 30 );

// lonyo woocommerce get sidebar
add_action('woocommerce_sidebar','lonyo_woocommerce_get_sidebar',10);

/*
*   Content Product Hook
*/

// lonyo shop loop product thumbnail hook
add_action( 'woocommerce_before_shop_loop_item', 'lonyo_loop_product_thumbnail', 10 );

// lonyo shop loop hozrizontal product thumbnail hook
add_action( 'woocommerce_before_shop_horizontal_loop_item', 'lonyo_loop_product_thumbnail', 10 );

// lonyo shop loop product summary hook
add_action( 'woocommerce_after_shop_loop_item', 'lonyo_loop_product_summary', 10 );

// lonyo shop loop horizontal product summary hook
add_action('woocommerce_after_shop_horizonal_loop_item', 'lonyo_horizontal_loop_product_summary' );

// lonyo shop loop horizontal product summary hook
add_action('lonyo_woocommerce_shop_three_loop_product_summary','lonyo_woocommerce_shop_three_loop_product_summary_cb',10);
...
add_action('woocommerce_single_product_summary', 'lonyo_woocommerce_single_product_title', 10 );

// single product price and rating
add_action('woocommerce_single_product_summary', 'lonyo_woocommerce_single_product_price_rating', 10 );

// single product excerpt
add_action('woocommerce_single_product_summary', 'lonyo_woocommerce_single_product_excerpt', 40 );

// single product availability
add_action( 'woocommerce_single_product_summary', 'lonyo_woocommerce_single_product_availability', 50 );

// single product add to cart button
add_action('woocommerce_single_product_summary','lonyo_woocommerce_single_add_to_cart_button',60);

// single product meta hook
add_action('woocommerce_single_product_summary','lonyo_woocommerce_single_meta',80);

// single product sidebar
add_action('lonyo_woocommerce_single_product_sidebar','lonyo_woocommerce_single_product_sidebar_cb');

// single product price and rating
add_action('lonyo_quickview_single_product_summary','lonyo_woocommerce_single_product_price_rating',20);

// single product title
add_action('lonyo_quickview_single_product_summary','lonyo_woocommerce_quickview_single_product_title',30);

// single product excerpt
add_action('lonyo_quickview_single_product_summary','lonyo_woocommerce_single_product_excerpt',40);

// single product add to cart button
add_action('lonyo_quickview_single_product_summary','lonyo_woocommerce_single_add_to_cart_button',60);
...
add_action('woocommerce_review_before_comment_meta','lonyo_woocommerce_reviewer_meta',10,1);
...
add_action('woocommerce_proceed_to_checkout','lonyo_woocommerce_button_proceed_to_checkout',20);

// cross sell products
add_action('woocommerce_after_cart','lonyo_woocommerce_cross_sell_display',10);

// mini cart view cart button
add_action('woocommerce_widget_shopping_cart_buttons','lonyo_minicart_view_cart_button',10);

// mini cart checkout button
add_action('woocommerce_widget_shopping_cart_buttons','lonyo_minicart_checkout_button',20);

/*
*   checkout hook
*/

// lonyo woocommerce checkout login form
add_action('woocommerce_before_checkout_form','lonyo_woocommerce_before_checkout_form',10);
...
add_filter( 'woosc_button_html', 'lonyo_woosc_button_html', 10, 2 );
function lonyo_woosc_button_html( $output , $prodid ) {
...
add_filter( 'woosc_button_text_added', 'lonyo_woo_compare_btn_text_added', 10, 2 );
function lonyo_woo_compare_btn_text_added( ){
    return $output = '<i class="fal fa-layer-group"></i>';
}

add_filter( 'woosc_button_text', 'lonyo_compare_btn_text', 10, 2 );
function lonyo_compare_btn_text(){
    return $output = '<i class="fal fa-layer-group"></i>';
}
...
add_filter( 'woosq_button_html', 'lonyo_woosq_button_html', 10, 2 );
function lonyo_woosq_button_html( $output , $prodid ) {
