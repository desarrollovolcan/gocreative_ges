    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-3 mb-3">
                ...
                <input type="text" name="sii_receiver_rut" class="form-control" placeholder="12.345.678-9" value="<?php echo e($siiData['sii_receiver_rut'] ?? ''); ?>" <?php echo $requiredAttr; ?>>
            </div>
            <div class="col-md-3 mb-3">
                <label class="form-label">Razón social</label>
                <input type="text" name="sii_receiver_name" class="form-control" value="<?php echo e($siiData['sii_receiver_name'] ?? ''); ?>" <?php echo $requiredAttr; ?>>
            </div>
            <div class="col-md-3 mb-3">
                <label class="form-label">Giro</label>
                <input type="text" name="sii_receiver_giro" class="form-control" value="<?php echo e($siiData['sii_receiver_giro'] ?? ''); ?>" <?php echo $requiredAttr; ?>>
            </div>
            <div class="col-md-3 mb-3">
                <label class="form-label">Código actividad</label>
                <input type="text" name="sii_receiver_activity_code" class="form-control" value="<?php echo e($siiData['sii_receiver_activity_code'] ?? ''); ?>">
            </div>
            <div class="col-md-4 mb-3">
                <label class="form-label">Dirección</label>
                <input type="text" name="sii_receiver_address" class="form-control" value="<?php echo e($siiData['sii_receiver_address'] ?? ''); ?>" <?php echo $requiredAttr; ?>>
            </div>
            <div class="col-md-4 mb-3">
                <label class="form-label">Comuna</label>
                <input type="text" name="sii_receiver_commune" class="form-control" value="<?php echo e($siiData['sii_receiver_commune'] ?? ''); ?>" <?php echo $requiredAttr; ?>>
            </div>
            <div class="col-md-4 mb-3">
                <label class="form-label">Ciudad</label>
                <input type="text" name="sii_receiver_city" class="form-control" value="<?php echo e($siiData['sii_receiver_city'] ?? ''); ?>" <?php echo $requiredAttr; ?>>
            </div>
        </div>
    </div>
</div>
