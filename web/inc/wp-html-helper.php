...
// image default alt
if( !function_exists( 'lonyo_img_default_alt' ) ){
	function lonyo_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'lonyo_img_tag' ) ){
	function lonyo_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'lonyo_anchor_tag' ) ){
	function lonyo_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'lonyo_heading_tag' ) ){
	function lonyo_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'lonyo_paragraph_tag' ) ){
	function lonyo_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'lonyo_span_tag' ) ){
	function lonyo_span_tag( array $args ){
